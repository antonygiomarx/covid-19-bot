export const countries = [
  ...
  {
    nombre: 'AntiguayBarbuda', name: 'AntiguaandBarbuda', nom: 'AntiguaetBarbuda', iso2: 'AG', iso3: 'ATG', phone_code: '1268',
  },
  {
    nombre: 'AntillasNeerlandesas', name: 'NetherlandsAntilles', nom: 'AntillesNéerlandaises', iso2: 'AN', iso3: 'ANT', phone_code: '599',
  },
  {
    nombre: 'ArabiaSaudita', name: 'SaudiArabia', nom: 'ArabieSaoudite', iso2: 'SA', iso3: 'SAU', phone_code: '966',
  },
  {
  ...
  {
    nombre: 'BosniayHerzegovina', name: 'BosniaandHerzegovina', nom: 'Bosnie-Herzégovine', iso2: 'BA', iso3: 'BIH', phone_code: '387',
  },
  {
  ...
  {
    nombre: 'CiudaddelVaticano', name: 'VaticanCityState', nom: 'CitéduVatican', iso2: 'VA', iso3: 'VAT', phone_code: '39',
  },
  {
  ...
  {
    nombre: 'CoreadelNorte', name: 'NorthKorea', nom: 'CoréeduNord', iso2: 'KP', iso3: 'PRK', phone_code: '850',
  },
  {
    nombre: 'CoreadelSur', name: 'SouthKorea', nom: 'CoréeduSud', iso2: 'KR', iso3: 'KOR', phone_code: '82',
  },
  {
    nombre: 'CostadeMarfil', name: 'IvoryCoast', nom: "Côte-d'Ivoire", iso2: 'CI', iso3: 'CIV', phone_code: '225',
  },
  {
    nombre: 'CostaRica', name: 'CostaRica', nom: 'CostaRica', iso2: 'CR', iso3: 'CRI', phone_code: '506',
  },
  {
  ...
  {
    nombre: 'ElSalvador', name: 'ElSalvador', nom: 'ElSalvador', iso2: 'SV', iso3: 'SLV', phone_code: '503',
  },
  {
    nombre: 'EmiratosÁrabesUnidos', name: 'UnitedArabEmirates', nom: 'EmiratsArabesUnis', iso2: 'AE', iso3: 'ARE', phone_code: '971',
  },
  {
  ...
  {
    nombre: 'Estados Unidos de América', name: 'United States of America', nom: "États-Unisd'Amérique", iso2: 'US', iso3: 'USA', phone_code: '1',
  },
  {
  ...
  {
    nombre: 'GuayanaFrancesa', name: 'FrenchGuiana', nom: 'Guyanefrançaise', iso2: 'GF', iso3: 'GUF', phone_code: '',
  },
  {
  ...
  {
    nombre: 'IslaBouvet', name: 'BouvetIsland', nom: 'BouvetIsland', iso2: 'BV', iso3: 'BVT', phone_code: '',
  },
  {
    nombre: 'IsladeMan', name: 'IsleofMan', nom: 'IledeMan', iso2: 'IM', iso3: 'IMN', phone_code: '44',
  },
  {
    nombre: 'IsladeNavidad', name: 'ChristmasIsland', nom: 'ChristmasIsland', iso2: 'CX', iso3: 'CXR', phone_code: '61',
  },
  {
    nombre: 'IslaNorfolk', name: 'NorfolkIsland', nom: 'ÎledeNorfolk', iso2: 'NF', iso3: 'NFK', phone_code: '',
  },
  {
    nombre: 'Islandia', name: 'Iceland', nom: 'Islande', iso2: 'IS', iso3: 'ISL', phone_code: '354',
  },
  {
    nombre: 'IslasBermudas', name: 'BermudaIslands', nom: 'Bermudes', iso2: 'BM', iso3: 'BMU', phone_code: '1441',
  },
  {
    nombre: 'IslasCaimán', name: 'CaymanIslands', nom: 'IlesCaïmans', iso2: 'KY', iso3: 'CYM', phone_code: '1345',
  },
  {
    nombre: 'IslasCocos(Keeling)', name: 'Cocos(Keeling)Islands', nom: 'Cocos(Keeling', iso2: 'CC', iso3: 'CCK', phone_code: '61',
  },
  {
    nombre: 'IslasCook', name: 'CookIslands', nom: 'IlesCook', iso2: 'CK', iso3: 'COK', phone_code: '682',
  },
  {
    nombre: 'IslasdeÅland', name: 'ÅlandIslands', nom: 'ÎlesÅland', iso2: 'AX', iso3: 'ALA', phone_code: '',
  },
  {
    nombre: 'IslasFeroe', name: 'FaroeIslands', nom: 'IlesFéro', iso2: 'FO', iso3: 'FRO', phone_code: '298',
  },
  {
    nombre: 'IslasGeorgiasdelSurySandwichdelSur', name: 'SouthGeorgiaandtheSouthSandwichIslands', nom: 'GéorgieduSudetlesÎlesSandwichduSud', iso2: 'GS', iso3: 'SGS', phone_code: '',
  },
  {
    nombre: 'IslasHeardyMcDonald', name: 'HeardIslandandMcDonaldIslands', nom: 'LesîlesHeardetMcDonald', iso2: 'HM', iso3: 'HMD', phone_code: '',
  },
  {
    nombre: 'IslasMaldivas', name: 'Maldives', nom: 'Maldives', iso2: 'MV', iso3: 'MDV', phone_code: '960',
  },
  {
    nombre: 'IslasMalvinas', name: 'FalklandIslands(Malvinas)', nom: 'IlesFalkland(Malvinas', iso2: 'FK', iso3: 'FLK', phone_code: '500',
  },
  {
    nombre: 'IslasMarianasdelNorte', name: 'NorthernMarianaIslands', nom: 'IlesMariannesduNord', iso2: 'MP', iso3: 'MNP', phone_code: '1670',
  },
  {
    nombre: 'IslasMarshall', name: 'MarshallIslands', nom: 'IlesMarshall', iso2: 'MH', iso3: 'MHL', phone_code: '692',
  },
  {
    nombre: 'IslasPitcairn', name: 'PitcairnIslands', nom: 'IlesPitcairn', iso2: 'PN', iso3: 'PCN', phone_code: '870',
  },
  {
    nombre: 'IslasSalomón', name: 'SolomonIslands', nom: 'IlesSalomon', iso2: 'SB', iso3: 'SLB', phone_code: '677',
  },
  {
    nombre: 'IslasTurcasyCaicos', name: 'TurksandCaicosIslands', nom: 'IlesTurquesetCaïques', iso2: 'TC', iso3: 'TCA', phone_code: '1649',
  },
  {
    nombre: 'IslasUltramarinasMenoresdeEstadosUnidos', name: 'UnitedStatesMinorOutlyingIslands', nom: 'États-UnisÎlesmineureséloignées', iso2: 'UM', iso3: 'UMI', phone_code: '',
  },
  {
    nombre: 'IslasVírgenesBritánicas', name: 'VirginIslands', nom: 'IlesVierges', iso2: 'VG', iso3: 'VG', phone_code: '1284',
  },
  {
    nombre: 'IslasVírgenesdelosEstadosUnidos', name: 'UnitedStatesVirginIslands', nom: 'ÎlesViergesaméricaines', iso2: 'VI', iso3: 'VIR', phone_code: '1340',
  },
  {
  ...
  {
    nombre: 'NuevaCaledonia', name: 'NewCaledonia', nom: 'Nouvelle-Calédonie', iso2: 'NC', iso3: 'NCL', phone_code: '687',
  },
  {
    nombre: 'NuevaZelanda', name: 'NewZealand', nom: 'Nouvelle-Zélande', iso2: 'NZ', iso3: 'NZL', phone_code: '64',
  },
  {
    nombre: 'Omán', name: 'Oman', nom: 'Oman', iso2: 'OM', iso3: 'OMN', phone_code: '968',
  },
  {
    nombre: 'PaísesBajos', name: 'Netherlands', nom: 'Pays-Bas', iso2: 'NL', iso3: 'NLD', phone_code: '31',
  },
  {
  ...
  {
    nombre: 'PapúaNuevaGuinea', name: 'PapuaNewGuinea', nom: 'Papouasie-Nouvelle-Guinée', iso2: 'PG', iso3: 'PNG', phone_code: '675',
  },
  {
  ...
  {
    nombre: 'PolinesiaFrancesa', name: 'FrenchPolynesia', nom: 'Polynésiefrançaise', iso2: 'PF', iso3: 'PYF', phone_code: '689',
  },
  {
  ...
  {
    nombre: 'PuertoRico', name: 'PuertoRico', nom: 'PortoRico', iso2: 'PR', iso3: 'PRI', phone_code: '1',
  },
  {
    nombre: 'Qatar', name: 'Qatar', nom: 'Qatar', iso2: 'QA', iso3: 'QAT', phone_code: '974',
  },
  {
    nombre: 'ReinoUnido', name: 'UnitedKingdom', nom: 'Royaume-Uni', iso2: 'GB', iso3: 'GBR', phone_code: '44',
  },
  {
    nombre: 'RepúblicaCentroafricana', name: 'CentralAfricanRepublic', nom: 'RépubliqueCentrafricaine', iso2: 'CF', iso3: 'CAF', phone_code: '236',
  },
  {
    nombre: 'RepúblicaCheca', name: 'CzechRepublic', nom: 'RépubliqueTchèque', iso2: 'CZ', iso3: 'CZE', phone_code: '420',
  },
  {
  ...
  {
    nombre: 'SaharaOccidental', name: 'WesternSahara', nom: 'SaharaOccidental', iso2: 'EH', iso3: 'ESH', phone_code: '',
  },
  {
    nombre: 'Samoa', name: 'Samoa', nom: 'Samoa', iso2: 'WS', iso3: 'WSM', phone_code: '685',
  },
  {
    nombre: 'SamoaAmericana', name: 'AmericanSamoa', nom: 'LesSamoaaméricaines', iso2: 'AS', iso3: 'ASM', phone_code: '1684',
  },
  {
    nombre: 'SanBartolomé', name: 'SaintBarthélemy', nom: 'Saint-Barthélemy', iso2: 'BL', iso3: 'BLM', phone_code: '590',
  },
  {
    nombre: 'SanCristóbalyNieves', name: 'SaintKittsandNevis', nom: 'SaintKittsetNevis', iso2: 'KN', iso3: 'KNA', phone_code: '1869',
  },
  {
    nombre: 'SanMarino', name: 'SanMarino', nom: 'SanMarino', iso2: 'SM', iso3: 'SMR', phone_code: '378',
  },
  {
    nombre: 'SanMartín(Francia)', name: 'SaintMartin(Frenchpart)', nom: 'Saint-Martin(partiefrançaise)', iso2: 'MF', iso3: 'MAF', phone_code: '1599',
  },
  {
    nombre: 'SanPedroyMiquelón', name: 'SaintPierreandMiquelon', nom: 'Saint-Pierre-et-Miquelon', iso2: 'PM', iso3: 'SPM', phone_code: '508',
  },
  {
    nombre: 'SanVicenteylasGranadinas', name: 'SaintVincentandtheGrenadines', nom: 'Saint-VincentetGrenadines', iso2: 'VC', iso3: 'VCT', phone_code: '1784',
  },
  {
    nombre: 'SantaElena', name: 'AscensiónyTristándeAcuña', nom: 'AscensiónyTristandeAcuña', iso2: 'SH', iso3: 'SHN', phone_code: '290',
  },
  {
    nombre: 'SantaLucía', name: 'SaintLucia', nom: 'Sainte-Lucie', iso2: 'LC', iso3: 'LCA', phone_code: '1758',
  },
  {
    nombre: 'SantoToméyPríncipe', name: 'SaoTomeandPrincipe', nom: 'SaoToméetPrincipe', iso2: 'ST', iso3: 'STP', phone_code: '239',
  },
  {
  ...
  {
    nombre: 'SierraLeona', name: 'SierraLeone', nom: 'SierraLeone', iso2: 'SL', iso3: 'SLE', phone_code: '232',
  },
  {
  ...
  {
    nombre: 'SvalbardyJanMayen', name: 'SvalbardandJanMayen', nom: 'SvalbardetJanMayen', iso2: 'SJ', iso3: 'SJM', phone_code: '',
  },
  {
  ...
  {
    nombre: 'TerritorioBritánicodelOcéanoÍndico', name: 'BritishIndianOceanTerritory', nom: "Territoirebritanniquedel'océanIndien", iso2: 'IO', iso3: 'IOT', phone_code: '',
  },
  {
    nombre: 'TerritoriosAustralesyAntárticasFranceses', name: 'FrenchSouthernTerritories', nom: 'Terresaustralesfrançaises', iso2: 'TF', iso3: 'ATF', phone_code: '',
  },
  {
  ...
  {
    nombre: 'TrinidadyTobago', name: 'TrinidadandTobago', nom: 'TrinidadetTobago', iso2: 'TT', iso3: 'TTO', phone_code: '1868',
  },
  {
  ...
  {
    nombre: 'WallisyFutuna', name: 'WallisandFutuna', nom: 'WallisetFutuna', iso2: 'WF', iso3: 'WLF', phone_code: '681',
  },
  {
